...
public interface ProjectDao {
	   ...
	   int getProejctId();
		...
		/*
		 * @Delete("DELETE FROM projects WHERE projectid = #{projectid}") int
		 * delete(@Param("projectid") Long projectid); //프로젝트 삭제
		 */	    
	    @Select(""" 
	    ...
	    //empno가 만든 프로젝트
	        ...
	        @Delete("""
	        	    DELETE FROM project_members WHERE project_id = #{projectId} AND empno = #{empno}
	        	""")
	        	void deleteMember(@Param("projectId") Long projectId, @Param("empno") String empno);
