...
public class TaskTodo {
	    ...
	    private String todo_review_status;	
		...
		public String getTodo_review_status() {
			return todo_review_status;
		}
		public void setTodo_review_status(String todo_review_status) {
			this.todo_review_status = todo_review_status;
		}
		public TaskTodo() {
			super();
			// TODO Auto-generated constructor stub
		}
		public TaskTodo(Long taskid, String text, String task_start_date, String task_end_date, String task_status,
				Long projectid, Long todoid, String empno, String todo_tasktext, String todo_start_date,
				String todo_end_date, String todo_status) {
			super();
			this.taskid = taskid;
			this.text = text;
