                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">예산 확인하기</h1>
                                        </div>
                                                ...
                                                <tbody>
                                                    <c:forEach var="project" items="${projectsgantt}">
                                                        <tr>
                                                            ...
                                                            <td>${project.empno}</td>
                                                            <td><fmt:formatDate value="${project.createdat}" pattern="yyyy-MM-dd" /></td>
                                                            <td>
                                                                <a href="${path}/projects/${project.projectid}/budgetList" class="btn btn-primary">예산 페이지 바로가기</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
