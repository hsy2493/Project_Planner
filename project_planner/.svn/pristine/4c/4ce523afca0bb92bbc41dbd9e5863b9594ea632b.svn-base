...
public class TodoController {
 ...
 // 파일 삭제 처리 메서드
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable Long todoid, @PathVariable String filename) {
        try {
           
            Path filePath = Paths.get("uploads/" + todoid + "/" + filename).normalize();
